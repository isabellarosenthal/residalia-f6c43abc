  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[420px]">
        <DialogHeader><DialogTitle className="font-display text-xl text-[#374151]">Pase de acceso</DialogTitle></DialogHeader>
        {acceso && (
          <div className="space-y-4">
            <div className="bg-[#F8FAFC] rounded-2xl p-4 text-center">
              ...
              <div className="font-mono text-lg font-bold text-[#374151] tracking-widest">{acceso.qr_code}</div>
            </div>
