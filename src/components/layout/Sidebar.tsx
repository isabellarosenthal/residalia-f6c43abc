...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-60 h-screen sticky top-0 bg-[#173B7A] text-[#F8FAFC]">
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${
                  path.startsWith("/admin-panel")
                    ? "bg-gradient-to-r from-[#D9A441] to-[#7a2e0a] text-white font-semibold"
                    : "text-[#F8FAFC] hover:bg-[#D9A441]/15"
                }`}
              >
              ...
              {sec.items.map((it) => {
                ...
                return (
                  <Link
                    ...
                    to={it.to}
                    className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${
                      active ? "bg-[#D9A441] text-[#173B7A] font-semibold" : "text-[#F8FAFC] hover:bg-[#D9A441]/15"
                    }`}
                  >
      ...
      <div className="border-t border-[#F8FAFC]/15 p-3">
        <div className="flex items-center gap-3 px-2 py-2">
          <div className="w-9 h-9 rounded-full bg-[#D9A441] text-white flex items-center justify-center font-semibold text-sm shrink-0">
          ...
          <button
            ...
            className="p-2 rounded-lg hover:bg-[#D9A441]/20 text-[#F8FAFC]/80 hover:text-white transition-colors"
            title="Cerrar sesión"
          >
