...
export function Topbar() {
  ...
  return (
    <header className="h-16 bg-white border-b border-[#e8ddd8] flex items-center px-6 gap-4 sticky top-0 z-20">
      ...
      <button className="relative p-2 rounded-full hover:bg-[#f5ede8]">
        <Bell className="w-5 h-5 text-[#4a2800]" />
        <span className="absolute top-1 right-1 w-2 h-2 bg-[#c0392b] rounded-full" />
      </button>
      <div className="w-9 h-9 rounded-full bg-[#c94f0c] text-white flex items-center justify-center font-semibold text-sm">
