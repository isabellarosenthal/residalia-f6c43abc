...
function Row({ edificio, stats, onEdit }: { edificio: Condominio; stats?: StatsExt; onEdit: () => void }) {
  ...
  return (
    <TableRow onClick={go} className="cursor-pointer hover:bg-[#faf6f3]">
      <TableCell>
        <div className="font-semibold text-[#4A154B]">{edificio.nombre}</div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-[#F8FAFC] hover:bg-[#F8FAFC]">
              ...
              <TableHead className="text-[#4A154B] font-semibold">Unidades</TableHead>
              <TableHead className="text-[#4A154B] font-semibold">Ocupación</TableHead>
              <TableHead className="text-[#4A154B] font-semibold">Venta / Renta</TableHead>
              <TableHead className="text-[#4A154B] font-semibold">Cuota base</TableHead>
