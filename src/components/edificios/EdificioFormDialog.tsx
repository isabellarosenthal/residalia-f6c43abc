  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[640px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-display text-xl text-[#374151]">{edificio ? "Editar edificio" : "Nuevo edificio"}</DialogTitle>
        </DialogHeader>
            ...
            <div className="mt-2 flex gap-2">
              ...
              {form.watch("maps_url") ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center h-10 px-3 rounded-md border border-[#E2E8F0] text-[#374151] hover:bg-[#fdeee5]"
