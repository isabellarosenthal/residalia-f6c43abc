      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-[#F8FAFC] hover:bg-[#F8FAFC]">
            <TableHead className="text-[#2D3748] font-semibold">Fecha</TableHead>
            <TableHead className="text-[#2D3748] font-semibold">Categoría</TableHead>
            <TableHead className="text-[#2D3748] font-semibold">Proveedor</TableHead>
            <TableHead className="text-[#2D3748] font-semibold">Descripción</TableHead>
