      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-[#F8FAFC] hover:bg-[#F8FAFC]">
            <TableHead className="text-[#4A154B] font-semibold">Fecha</TableHead>
            <TableHead className="text-[#4A154B] font-semibold">Categoría</TableHead>
            <TableHead className="text-[#4A154B] font-semibold">Proveedor</TableHead>
            <TableHead className="text-[#4A154B] font-semibold">Descripción</TableHead>
