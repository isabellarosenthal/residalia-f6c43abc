    ...
    <div className="space-y-5">
      ...
      <Card className="p-5">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-display font-bold text-[#0F172A]">Estado de resultados</h3>
        ...
        <div className="mt-4 pt-3 border-t border-[#E2E8F0] flex items-center justify-between">
          <span className="font-display font-bold text-[#0F172A]">Utilidad del periodo</span>
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <Card className="p-5">
          <h3 className="font-display font-bold text-[#0F172A] mb-3">Ingresos por concepto</h3>
          <div className="h-64">
        ...
        <Card className="p-5">
          <h3 className="font-display font-bold text-[#0F172A] mb-3">Egresos por categoría</h3>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <Card className="p-5">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-display font-bold text-[#0F172A]">Top 10 morosos</h3>
      ...
      <Card className="p-5">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-display font-bold text-[#0F172A]">Flujo de caja</h3>
