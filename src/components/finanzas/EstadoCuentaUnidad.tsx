      ...
      {unidadId && (
        <>
          <div className="print:block hidden mb-4">
            <h2 className="font-display font-extrabold text-2xl text-[#2d1200]">Estado de cuenta</h2>
            <div className="text-sm text-[#9a7060]">Unidad #{unidad?.numero} · {residente ? `${residente.nombre} ${residente.apellido}` : "Sin residente"}</div>
            <div className="text-xs text-[#9a7060]">Generado: {fmtDate(new Date())}</div>
          </div>

          <div className="grid grid-cols-3 gap-3">
            <div className="p-3 rounded-xl bg-[#f5ede8]"><div className="text-xs text-[#9a7060]">Pagado</div><div className="font-display font-bold text-[#2d6a2d] text-lg">{fmtL(totalPagado)}</div></div>
            <div className="p-3 rounded-xl bg-[#f5ede8]"><div className="text-xs text-[#9a7060]">Pendiente</div><div className="font-display font-bold text-[#c94f0c] text-lg">{fmtL(totalPendiente)}</div></div>
            <div className="p-3 rounded-xl bg-[#f5ede8]"><div className="text-xs text-[#9a7060]">Vencido</div><div className="font-display font-bold text-[#c0392b] text-lg">{fmtL(totalVencido)}</div></div>
          </div>
