    ...
    <div className="space-y-5">
      <Card className="p-5">
        <div className="flex items-start gap-3 mb-3">
          <BellRing className="w-5 h-5 text-[#374151] mt-0.5" />
          <div>
            <h3 className="font-display font-bold text-[#374151]">Recordatorios a morosos</h3>
      ...
      <Card className="p-5">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-display font-bold text-[#374151]">{morosos.length} residente{morosos.length === 1 ? "" : "s"} con saldo</h3>
        </div>
            ...
            return (
              <div key={m.residenteId} className="border border-[#E2E8F0] rounded-xl p-4 flex flex-wrap gap-4 items-start">
                <div className="flex-1 min-w-[200px]">
                  <div className="font-semibold text-[#374151]">{m.nombre} <span className="text-xs text-[#64748B] font-normal">· Unidad {m.unidad}</span></div>
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                  ...
                  <Button size="sm" className="bg-[#374151] hover:bg-[#1F2937]" disabled={!ml} asChild={!!ml}>
