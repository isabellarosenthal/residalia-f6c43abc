...
export function ResidenteForm({
  residente, defaultCondominioId, onSaved, onCancel,
}: { residente?: Residente | null; defaultCondominioId?: string; onSaved?: () => void; onCancel?: () => void }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[640px] max-h-[90vh] overflow-y-auto">
        ...
        <ResidenteForm
          residente={residente}
          defaultCondominioId={defaultCondominioId}
