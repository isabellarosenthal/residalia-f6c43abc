      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-[#F8FAFC] hover:bg-[#F8FAFC]">
            <TableHead className="text-[#173B7A] font-semibold">Residente</TableHead>
            <TableHead className="text-[#173B7A] font-semibold">Tipo</TableHead>
            <TableHead className="text-[#173B7A] font-semibold">Edificio · Unidad</TableHead>
            <TableHead className="text-[#173B7A] font-semibold">Contacto</TableHead>
            <TableHead className="text-[#173B7A] font-semibold">Ingreso</TableHead>
        ...
        <TableBody>
          ...
          {filtered.map((r) => (
            <TableRow key={r.id}>
              <TableCell>
                <div className="font-semibold text-[#173B7A]">{r.nombre} {r.apellido}</div>
              ...
              <TableCell className="text-sm">
                <div className="text-[#173B7A]">{edifMap.get(r.condominio_id) ?? "—"}</div>
