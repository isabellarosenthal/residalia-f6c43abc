    ...
    <AppShell>
      <div className="space-y-5 max-w-[1400px] mx-auto">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="font-display font-extrabold text-2xl text-[#374151]">Finanzas</h1>
        ...
        <Tabs defaultValue="resumen">
          ...
          <TabsContent value="cobros" className="space-y-4 pt-4">
            <div className="flex flex-wrap gap-2 justify-end">
              ...
              <Button onClick={() => { setCobroEdit(null); setCobroOpen(true); }} className="bg-[#374151] hover:bg-[#1F2937]">
          ...
          <TabsContent value="egresos" className="space-y-4 pt-4">
            <div className="flex justify-end">
              <Button onClick={() => { setEgresoEdit(null); setEgresoOpen(true); }} className="bg-[#374151] hover:bg-[#1F2937]">
