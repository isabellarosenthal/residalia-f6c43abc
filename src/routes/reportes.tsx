    ...
    <AppShell>
      <div className="space-y-5 max-w-[1400px] mx-auto">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="font-display font-extrabold text-2xl text-[#4F46E5]">Reportes</h1>
        ...
        <Tabs defaultValue="financiero">
          ...
          <TabsContent value="financiero" className="pt-4 space-y-4">
            <Card className="p-5">
              <h3 className="font-display font-bold text-lg text-[#4F46E5] mb-4">Ingresos vs Egresos (6 meses)</h3>
            ...
            <Card className="p-5">
              <h3 className="font-display font-bold text-lg text-[#4F46E5] mb-4">Egresos por categoría</h3>
          ...
          <TabsContent value="ocupacion" className="pt-4 space-y-4">
            <Card className="p-5">
              <h3 className="font-display font-bold text-lg text-[#4F46E5] mb-4">Ocupación por edificio</h3>
          ...
          <TabsContent value="crm" className="pt-4 space-y-4">
            <Card className="p-5">
              <h3 className="font-display font-bold text-lg text-[#4F46E5] mb-4">Prospectos por etapa</h3>
              <ResponsiveContainer width="100%" height={300}>
          ...
          <TabsContent value="exportar" className="pt-4">
            <Card className="p-5 space-y-3">
              <h3 className="font-display font-bold text-lg text-[#4F46E5]">Exportar a CSV</h3>
