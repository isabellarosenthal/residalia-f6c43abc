      ...
      <div className="space-y-5 max-w-[1400px] mx-auto">
        ...
        <Tabs defaultValue="financiero">
          ...
          <TabsContent value="financiero" className="pt-4 space-y-4">
            <Card className="p-5">
              <h3 className="font-display font-bold text-lg text-[#0F172A] mb-4">Ingresos vs Egresos (6 meses)</h3>
            ...
            <Card className="p-5">
              <h3 className="font-display font-bold text-lg text-[#0F172A] mb-4">Egresos por categoría</h3>
          ...
          <TabsContent value="ocupacion" className="pt-4 space-y-4">
            <Card className="p-5">
              <h3 className="font-display font-bold text-lg text-[#0F172A] mb-4">Ocupación por edificio</h3>
