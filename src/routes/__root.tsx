...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Residalia — Administración de condominios y CRM inmobiliario" },
      { name: "description", content: "Plataforma unificada de administración de condominios y CRM inmobiliario para Centroamérica." },
      { property: "og:title", content: "Residalia — Administración de condominios y CRM inmobiliario" },
      { name: "twitter:title", content: "Residalia — Administración de condominios y CRM inmobiliario" },
