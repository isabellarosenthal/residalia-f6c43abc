  ...
  return (
    <Card className="p-6 space-y-4">
      ...
      <div className="flex justify-end">
        <Button onClick={save} disabled={saving} className="bg-[#374151] hover:bg-[#1F2937]">
          ...
          {editing === e.id ? (
            <div className="space-y-3">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button className="bg-[#374151] hover:bg-[#1F2937]" onClick={async () => {
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="font-display font-bold text-[#374151]">{e.nombre}</div>
  ...
  return (
    ...
    <Card className="p-5 space-y-4">
      <div className="border border-dashed border-[#E2E8F0] rounded-xl p-4 bg-[#ffffff]">
        <div className="text-sm font-medium text-[#374151] mb-2">Asignar rol por email</div>
        ...
        <div className="divide-y divide-[#f0e6e0]">
          {rows.map(r => (
            <div key={r.id} className="py-3 flex items-center justify-between gap-3">
              <div>
                <div className="font-medium text-[#374151]">{r.full_name}</div>
...
function TenantUsuariosTab({ edificios }: { edificios: Edif[] }) {
  ...
  return (
    ...
    <Card className="p-5 space-y-4">
      ...
      <div className="border border-dashed border-[#E2E8F0] rounded-xl p-4 bg-[#ffffff]">
        <div className="text-sm font-medium text-[#374151] mb-2">Invitar staff o guardia</div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button className="bg-[#374151] hover:bg-[#1F2937]" onClick={assign}><Plus className="w-4 h-4 mr-1" />Asignar</Button>
        </div>
      </div>
        ...
        <div className="divide-y divide-[#f0e6e0]">
          {members.map(m => (
            <div key={m.id} className="py-3 flex items-center justify-between gap-3">
              <div>
                <div className="font-medium text-[#374151]">{m.full_name}</div>
  ...
  return (
    <div className="space-y-4">
      <Card className="p-6 space-y-3">
        <h3 className="font-display font-bold text-lg text-[#374151]">Cambiar contraseña</h3>
        <div className="flex gap-2">
          <Input type="password" placeholder="Nueva contraseña" value={pwd} onChange={(e) => setPwd(e.target.value)} className="max-w-sm" />
          <Button onClick={change} disabled={saving} className="bg-[#374151] hover:bg-[#1F2937]"><Save className="w-4 h-4 mr-1" />Cambiar</Button>
        </div>
      </Card>
  ...
  return (
    ...
    <Card className="p-6 space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h3 className="font-display font-bold text-lg text-[#374151]">Residentes</h3>
            ...
            <tbody>
              {filtered.map((r) => (
                <tr key={r.id} className="border-b border-[#F8FAFC]">
                  <td className="py-2 pr-3 font-medium text-[#374151]">{r.nombre} {r.apellido}</td>
    ...
    <div className="space-y-4">
      <Card>
        <div className="p-5 flex items-center justify-between flex-wrap gap-3">
          <div>
            ...
            <div className="font-display font-extrabold text-2xl text-[#374151]">{data.plan.nombre}</div>
            <div className="text-sm text-[#64748B]">L {data.plan.precio.toLocaleString()} / mes</div>
          </div>
          <Link to="/" hash="planes">
            <Button className="bg-[#D97757] hover:bg-[#E8916F] text-[#374151] font-semibold rounded-full px-5">Actualizar plan</Button>
          </Link>
        </div>
      </Card>
      ...
      <Card>
        <div className="p-5 space-y-2">
          <div className="flex items-center justify-between">
            <div className="font-semibold text-[#374151]">Edificios</div>
