    ...
    <AppShell>
      <div className="space-y-5 max-w-[1400px] mx-auto">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="font-display font-extrabold text-2xl text-[#2D3748]">Control de Accesos</h1>
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={() => { setEdit(null); setOpen(true); }} className="bg-[#2D3748] hover:bg-[#1F2937]">
