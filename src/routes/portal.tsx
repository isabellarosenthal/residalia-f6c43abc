...
function PortalLayoutInner() {
  ...
  const { isLoading: residenciasLoading } = useResidenciaActiva();
  ...
  if (loading || residenciasLoading || !user || (role && role !== "residente" && role !== "super_admin")) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#ffffff]">
        <PortalLoading label="Cargando portal…" />
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] pb-20">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#E2E8F0] z-10 safe-area-pb">
