...
function NuevoPase() {
  ...
  return (
    <form onSubmit={submit} className="space-y-4 bg-white border border-[#E2E8F0] rounded-2xl p-5">
      <h1 className="font-display font-extrabold text-xl text-[#374151]">Crear pase de acceso</h1>
      <div>
      ...
      <Button type="submit" disabled={save.isPending || !visitante.trim()} className="w-full bg-[#374151] hover:bg-[#1F2937]">
