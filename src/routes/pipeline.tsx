    ...
    <AppShell>
      <div className="space-y-5 max-w-[1600px] mx-auto">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="font-display font-extrabold text-2xl text-[#374151]">Pipeline</h1>
                ...
                return (
                  ...
                  >
                    <div className="p-3 flex items-center justify-between">
                      <div>
                        <h3 className="font-semibold text-[#374151] text-sm">{etapaLabel(etapa)}</h3>
                        <span className="text-xs text-[#64748B]">{items.length}</span>
                      </div>
                      <button onClick={() => openNew(etapa)} className="p-1 rounded hover:bg-[#F8FAFC] text-[#374151]">
                        ...
                        >
                          <div className="flex items-start justify-between gap-2">
                            <div className="min-w-0 flex-1">
                              <p className="font-medium text-sm text-[#374151] truncate">{p.nombre} {p.apellido ?? ""}</p>
